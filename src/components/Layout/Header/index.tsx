      ...
      <div className="lg:py-0 py-2">
        <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md flex items-center justify-between px-4">
          ...
          <div className="flex items-center gap-3">
            <Link
              href="#"
              className="hidden lg:block border-2 border-primary bg-transparent text-primary hover:bg-primary hover:text-white px-8 py-3 rounded-full text-base font-medium transition-all duration-300"
              onClick={() => {
            ...
            <Link
              href="#"
              className="hidden lg:block bg-primary text-white hover:bg-primary/90 hover:shadow-lg px-8 py-3 rounded-full text-base font-medium transition-all duration-300"
              onClick={() => {
